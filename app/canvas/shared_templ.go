...
func SharedPage(title string, slug string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 2, " — Shared Canvas</title><link rel=\"icon\" type=\"image/jpeg\" href=\"/static/goth_lady_logo.jpg\"><link rel=\"preconnect\" href=\"https://fonts.googleapis.com\"><link rel=\"preconnect\" href=\"https://fonts.gstatic.com\" crossorigin=\"anonymous\"><link href=\"https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700;800&family=Fira+Code:wght@400;700&display=swap\" rel=\"stylesheet\"><link rel=\"stylesheet\" href=\"/globals.css\"><link rel=\"stylesheet\" href=\"/static/excalidraw.css\"><link rel=\"stylesheet\" href=\"/static/excalidraw-brutalist.css\"><style>\n\t\t\t\thtml, body { height: 100%; margin: 0; padding: 0; overflow: hidden; }\n\t\t\t\t#canvas-mount { width: 100vw; height: calc(100vh - 56px); min-height: 200px; }\n\t\t\t</style></head><body class=\"h-full bg-[var(--bg)] text-[var(--fg)] antialiased\"><header class=\"sticky top-0 z-50 w-full border-b-2 border-[var(--border)] bg-[var(--bg)]/95\"><div class=\"mx-auto flex h-14 max-w-7xl items-center justify-between px-6 lg:px-8\"><a href=\"/\" class=\"flex items-center gap-2.5 font-black tracking-tight text-[var(--fg)] select-none\"><img src=\"/static/goth_lady_logo.jpg\" class=\"h-8 w-8 border-2 border-[var(--border)] object-cover mix-blend-multiply dark:invert dark:mix-blend-screen\" alt=\"Gothic Lady Logo\"> <span class=\"text-sm font-bold uppercase tracking-wider\">Canvas</span></a> <span class=\"text-xs font-bold uppercase tracking-wider text-[var(--fg-muted)]\">Read-only view</span></div></header><div id=\"canvas-mount\" data-slug=\"")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `app/canvas/shared.templ`, Line: 32, Col: 42}
		}
